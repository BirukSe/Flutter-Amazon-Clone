...
import 'package:e_comm/common/widgets/starts.dart';
        ...
        body: SingleChildScrollView(
          ...
          children: [
            ...
            Padding(
                ...
                child:
                    Text(widget.product.name, style: TextStyle(fontSize: 15))),
            CarouselSlider(
            ...
            Padding(
              padding: const EdgeInsets.all(8.0), // Correctly named argument
            ...
            Padding(
              padding: const EdgeInsets.symmetric(
                  horizontal: 10), // Correctly named argument
